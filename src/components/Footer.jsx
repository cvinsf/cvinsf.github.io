  ...
  return (
    <div className="py-20 text-center">
      <div className="container max-w-screen-lg mx-auto">
        <div className="flex flex-wrap justify-center gap-3">
          <a
            ...
            className="bg-stone-400 p-2 font-semibild text-white inline-flex
                    items-center space-x-2 rounded-full"
          >
            <svg
      ...
      <p className="text-sm mt-2 opacity-65">
        &copy; {new Date().getFullYear()} Carlos Villarreal. All rights
        reserved.
      </p>
    </div>
  );
